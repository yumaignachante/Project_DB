        ...
        <tbody>
            ...
            {% endfor %}
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    {% if beds_data.has_prev %}
                                        <li class="page-item">
                                            <a class="page-link" href="{{ url_for('index_php', page=beds_data.prev_num, per_page=beds_data.per_page) }}">Previous</a>
                                        </li>
                                    {% else %}
                                    ...
                                    {% for page_num in beds_data.iter_pages() %}
                                        {% if page_num %}
                                            {% if beds_data.page == page_num %}
                                                <li class="page-item active">
                                                    <span class="page-link">{{ page_num }}</span>
                                                </li>
                                            {% else %}
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ url_for('index_php', page=page_num, per_page=beds_data.per_page) }}">{{ page_num }}</a>
                                                </li>
                                            {% endif %}
                                        {% else %}
                                            <li class="page-item disabled">
                                    ...
                                    {% if beds_data.has_next %}
                                        <li class="page-item">
                                            <a class="page-link" href="{{ url_for('index_php', page=beds_data.next_num, per_page=beds_data.per_page) }}">Next</a>
                                        </li>
                                    {% else %}
                                        <li class="page-item disabled">
